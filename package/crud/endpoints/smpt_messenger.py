...
import smtplib
import attr
from ..abc import Endpoint, Item
from ..utils import render_template

sample_msg = """
To: {{ to_addrs }}
From: {{ from_addr }}
Subject: Sample message generated on {{ now() }}.
...
class SMPTMessenger(Endpoint):
    ...
    def send(self, item: Union[Item, Mapping], to_addrs=None, msg_t=None,
             from_addr=None, dryrun=False):
